...
exports.buildInvestChatContextForChart = buildInvestChatContextForChart;
const connection_1 = require("../../database/connection");
const investContextBuilder_1 = require("./investContextBuilder");
/**
 * 标准化性别
 */
 ...
 */
async function buildInvestChatContextForChart(params) {
  ...
  `, [chartProfileId]);
    ...
    // 2. 调用统一的 builder
    return (0, investContextBuilder_1.buildInvestChatContext)({
        chartResult,
        gender,
        userQuestion,
        now,
...
//# sourceMappingURL=investDataService.js.map