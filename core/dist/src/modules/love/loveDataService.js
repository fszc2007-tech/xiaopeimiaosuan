...
exports.buildLoveChatContextForChart = buildLoveChatContextForChart;
const connection_1 = require("../../database/connection");
const loveContextBuilder_1 = require("./loveContextBuilder");
/**
 * 标准化性别
 */
 ...
 */
async function buildLoveChatContextForChart(params) {
  ...
  `, [chartProfileId]);
    ...
    // 2. 调用统一的 builder
    return (0, loveContextBuilder_1.buildLoveChatContext)({
        chartResult,
        gender,
        userQuestion,
        now,
...
//# sourceMappingURL=loveDataService.js.map