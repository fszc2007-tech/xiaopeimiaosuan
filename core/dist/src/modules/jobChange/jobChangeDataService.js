...
exports.buildJobChangeChatContextForChart = buildJobChangeChatContextForChart;
const connection_1 = require("../../database/connection");
const jobChangeContextBuilder_1 = require("./jobChangeContextBuilder");
/**
 * 标准化性别
 */
 ...
 */
async function buildJobChangeChatContextForChart(params) {
  ...
  `, [chartProfileId]);
    ...
    // 2. 调用统一的 builder
    return (0, jobChangeContextBuilder_1.buildJobChangeChatContext)({
        chartResult,
        gender,
        userQuestion,
        now,
...
//# sourceMappingURL=jobChangeDataService.js.map