...
exports.getChatFeedbackList = getChatFeedbackList;
 ...
 */
async function getChatFeedbackList(query) {
    ...
    // 查询总数
    const [countRows] = await pool.execute(`SELECT COUNT(*) as total FROM chat_message_feedback ${whereClause}`, params);
...
//# sourceMappingURL=chatFeedbackService.js.map