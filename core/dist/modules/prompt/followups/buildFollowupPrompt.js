...
exports.buildFallbackFollowups = buildFallbackFollowups;
const followupScenes_1 = require("./followupScenes");
/**
 * 兜底追问模板（常量配置）
 *
 * 当 LLM 生成失败或解析失败时使用
...
function buildFollowupPrompt(params) {
    ...
    const sceneHint = followupScenes_1.FOLLOWUP_SCENE_HINT[scene] || followupScenes_1.FOLLOWUP_SCENE_HINT['chat-general'];
 ...
 */
function buildFallbackFollowups(scene) {
    return FALLBACK_FOLLOWUPS[scene] || FALLBACK_FOLLOWUPS['chat-general'];
}
//# sourceMappingURL=buildFollowupPrompt.js.map