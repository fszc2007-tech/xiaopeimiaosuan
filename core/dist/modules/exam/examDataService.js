...
exports.buildExamChatContextForChart = buildExamChatContextForChart;
const connection_1 = require("../../database/connection");
const examContextBuilder_1 = require("./examContextBuilder");
/**
 * 标准化性别
 */
 ...
 */
async function buildExamChatContextForChart(params) {
  ...
  `, [chartProfileId]);
    ...
    // 2. 调用统一的 builder
    return (0, examContextBuilder_1.buildExamChatContext)({
        chartResult,
        gender,
        userQuestion,
        now,
...
//# sourceMappingURL=examDataService.js.map