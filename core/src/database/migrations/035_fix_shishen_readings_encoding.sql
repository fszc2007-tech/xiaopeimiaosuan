...
-- 版本：v1.1
-- 创建日期：2025-12-04
-- 用途：删除旧数据并重新插入正确编码的十神解读内容
-- 
-- 执行方式：
-- mysql -u root -p xiaopei --default-character-set=utf8mb4 < 035_fix_shishen_readings_encoding.sql
-- 
-- 注意：必须使用 --default-character-set=utf8mb4 参数，确保正确编码

-- 设置字符集
SET NAMES utf8mb4;

-- 先删除所有旧数据
DELETE FROM shishen_readings;
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('比肩在日柱對我的感情有什麼影響？', '我該如何在感情中平衡自我與妥協？', '比肩在日柱的人適合什麼樣的伴侶？', '如何讓比肩成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('比肩在時柱對我的晚年有什麼影響？', '我該如何培養子女的獨立性？', '比肩在時柱的人適合什麼樣的晚年生活？', '如何讓比肩成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('劫財在年柱對我的性格有什麼影響？', '我該如何處理競爭關係？', '劫財在年柱的人適合什麼樣的職業？', '如何發揮劫財的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('劫財在月柱對我的職場發展有什麼影響？', '我該如何處理職場競爭？', '劫財在月柱的人適合什麼樣的工作？', '如何將競爭轉化為優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('劫財在日柱對我的感情有什麼影響？', '我該如何在感情中處理競爭？', '劫財在日柱的人適合什麼樣的伴侶？', '如何讓劫財成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('劫財在時柱對我的晚年有什麼影響？', '我該如何處理晚年的競爭心態？', '劫財在時柱的人適合什麼樣的晚年生活？', '如何讓劫財成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('食神在年柱對我的性格有什麼影響？', '我該如何培養才藝？', '食神在年柱的人適合什麼樣的職業？', '如何發揮食神的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('食神在月柱對我的職場發展有什麼影響？', '我該如何發揮創意才能？', '食神在月柱的人適合什麼樣的工作？', '如何將才藝轉化為職業？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('食神在日柱對我的感情有什麼影響？', '我該如何在感情中享受生活？', '食神在日柱的人適合什麼樣的伴侶？', '如何讓食神成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('食神在時柱對我的晚年有什麼影響？', '我該如何培養子女的才藝？', '食神在時柱的人適合什麼樣的晚年生活？', '如何讓食神成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('傷官在年柱對我的性格有什麼影響？', '我該如何發揮表達能力？', '傷官在年柱的人適合什麼樣的職業？', '如何發揮傷官的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('傷官在月柱對我的職場發展有什麼影響？', '我該如何發揮創意才能？', '傷官在月柱的人適合什麼樣的工作？', '如何將創意轉化為職業？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('傷官在日柱對我的感情有什麼影響？', '我該如何在感情中表達自己？', '傷官在日柱的人適合什麼樣的伴侶？', '如何讓傷官成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('傷官在時柱對我的晚年有什麼影響？', '我該如何培養子女的思辨能力？', '傷官在時柱的人適合什麼樣的晚年生活？', '如何讓傷官成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正財在年柱對我的理財有什麼影響？', '我該如何培養理財習慣？', '正財在年柱的人適合什麼樣的職業？', '如何發揮正財的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正財在月柱對我的職場發展有什麼影響？', '我該如何追求穩定收入？', '正財在月柱的人適合什麼樣的工作？', '如何將務實轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正財在日柱對我的感情有什麼影響？', '我該如何在感情中處理財務？', '正財在日柱的人適合什麼樣的伴侶？', '如何讓正財成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正財在時柱對我的晚年有什麼影響？', '我該如何規劃退休理財？', '正財在時柱的人適合什麼樣的晚年生活？', '如何讓正財成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏財在年柱對我的理財有什麼影響？', '我該如何培養投資眼光？', '偏財在年柱的人適合什麼樣的職業？', '如何發揮偏財的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏財在月柱對我的職場發展有什麼影響？', '我該如何把握機會？', '偏財在月柱的人適合什麼樣的工作？', '如何將機遇轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏財在日柱對我的感情有什麼影響？', '我該如何在感情中處理新鮮感？', '偏財在日柱的人適合什麼樣的伴侶？', '如何讓偏財成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏財在時柱對我的晚年有什麼影響？', '我該如何規劃晚年投資？', '偏財在時柱的人適合什麼樣的晚年生活？', '如何讓偏財成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正官在年柱對我的性格有什麼影響？', '我該如何培養責任感？', '正官在年柱的人適合什麼樣的職業？', '如何發揮正官的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正官在月柱對我的職場發展有什麼影響？', '我該如何承擔責任？', '正官在月柱的人適合什麼樣的工作？', '如何將責任轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正官在日柱對我的感情有什麼影響？', '我該如何在感情中承擔責任？', '正官在日柱的人適合什麼樣的伴侶？', '如何讓正官成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  'neutral',
  '時柱正官，中晚年仍維持規律與自我要求',
  '時柱正官，多主中晚年仍維持一定的規律與自我要求，不輕易放任自己鬆散。對子女或晚輩較重視品行與責任，期望他們成為可靠之人。晚景若能在「守成」與「適度放鬆」之間取得平衡，既不失尊嚴，也能享受人生。',
  JSON_ARRAY('正官在時柱對我的晚年有什麼影響？', '我該如何培養子女的責任感？', '正官在時柱的人適合什麼樣的晚年生活？', '如何讓正官成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('七殺在年柱對我的性格有什麼影響？', '我該如何處理壓力？', '七殺在年柱的人適合什麼樣的職業？', '如何發揮七殺的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('七殺在月柱對我的職場發展有什麼影響？', '我該如何處理職場壓力？', '七殺在月柱的人適合什麼樣的工作？', '如何將壓力轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('七殺在日柱對我的感情有什麼影響？', '我該如何在感情中處理壓力？', '七殺在日柱的人適合什麼樣的伴侶？', '如何讓七殺成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('七殺在時柱對我的晚年有什麼影響？', '我該如何處理晚年的壓力？', '七殺在時柱的人適合什麼樣的晚年生活？', '如何讓七殺成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正印在年柱對我的性格有什麼影響？', '我該如何培養學習能力？', '正印在年柱的人適合什麼樣的職業？', '如何發揮正印的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正印在月柱對我的職場發展有什麼影響？', '我該如何發揮學習能力？', '正印在月柱的人適合什麼樣的工作？', '如何將學習轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正印在日柱對我的感情有什麼影響？', '我該如何在感情中照顧他人？', '正印在日柱的人適合什麼樣的伴侶？', '如何讓正印成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('正印在時柱對我的晚年有什麼影響？', '我該如何培養子女的學習能力？', '正印在時柱的人適合什麼樣的晚年生活？', '如何讓正印成為晚年的助力？'),
  TRUE,
  3
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏印在年柱對我的性格有什麼影響？', '我該如何培養靈感？', '偏印在年柱的人適合什麼樣的職業？', '如何發揮偏印的正面作用？'),
  TRUE,
  0
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏印在月柱對我的職場發展有什麼影響？', '我該如何發揮靈感？', '偏印在月柱的人適合什麼樣的工作？', '如何將靈感轉化為職業優勢？'),
  TRUE,
  1
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏印在日柱對我的感情有什麼影響？', '我該如何在感情中保持精神空間？', '偏印在日柱的人適合什麼樣的伴侶？', '如何讓偏印成為感情的助力？'),
  TRUE,
  2
);
...
INSERT INTO shishen_readings (
  ...
  JSON_ARRAY('偏印在時柱對我的晚年有什麼影響？', '我該如何培養子女的靈感？', '偏印在時柱的人適合什麼樣的晚年生活？', '如何讓偏印成為晚年的助力？'),
  TRUE,
  3
);
